...
namespace MiniShopApp.WebApi.Controllers
{
    ...
    public class ProductsController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetProducts()
        {
            ...
            //Burda bana dönmüş olan içerisinde Product tipinde veriler barındıran listemin içindeki tipi dönüştürüp, transfer etmek istiyorum.
        ...
        public async Task<IActionResult> UpdateProduct(int id,Product entity)
        {
            ...
            {
                return BadRequest(); //gerçekleşmesi mümkün olmayan bir istek
            }
            var product = await _productService.GetById(id);
            if (product == null)
            {
            ...
            return NoContent(); //başarılı kodlar
        }
        [HttpDelete("{id}")]
